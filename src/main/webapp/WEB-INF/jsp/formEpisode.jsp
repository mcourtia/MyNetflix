...
<body>
	...
	<div id="bloc">
		...
		<form action="/myNetflixJsp/addEpisode" method="post" accept-charset="utf-8">
			...
			<div>
				<input id="dateReal" name="dateReal" type="text" placeholder="Date de réalisation AAAA-MM-JJ">
			</div>
			<div>
				<input id="dateDiff" name="dateDiff" type="text" placeholder="Date de diffusion AAAA-MM-JJ">
			</div>
			<div>
			...
			<button type="submit" id="button">Ajouter Épisode</button>
		</form>
